									...
									<div class="main-profile-overview">
										...
										<div class="d-flex justify-content-between mg-b-20">
											<div>
												...
												<p class="main-profile-name-text">{{ $data->email }}</p>
											</div>
										</div>
										<h6>Bio</h6>
							...
							<div class="card-body">
								...
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
									...
									<div class="tab-pane" id="settings">
										<form role="form" method="post" action="{{ route('Profile_update_admin', $data->id) }}">
											@csrf
											<div class="form-group">
												<label for="FullName">Full Name</label>
												<input name="name" type="text" value="{{ $data->name }}" id="FullName" class="form-control">
											</div>
											<div class="form-group">
												<label for="Email">Email</label>
												<input name="email" type="email" value="{{ $data->email }}" id="Email" class="form-control">
											</div>
										
											<div class="form-group">
												<label for="Password">Password</label>
												<input name="password" type="password" placeholder="6 - 15 Characters" id="Password" class="form-control">
											</div>
											<div class="form-group">
												<label for="RePassword">Re-Password</label>
												<input name="password_confiram" type="password" placeholder="6 - 15 Characters" id="RePassword" class="form-control">
											</div>
											{{-- <div class="form-group">
