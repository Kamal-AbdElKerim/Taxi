									...
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="mr-3 my-auto">
												@if(auth('web')->check())
												<h6 class="px-1">{{ Str::limit(auth('web')->user()->name, 15, '...') }}</h6>
												<p class="text-light  px-1">{{ Str::limit(auth('web')->user()->email, 15, '...') }}</p>

												@else
												<h6 class="px-1">{{ Str::limit(auth('Admin')->user()->name, 15, '...') }}</h6>
												<p class="text-light  px-1">{{ Str::limit(auth('Admin')->user()->email, 15, '...') }}</p>
												@endif
											</div>
										</div>
									</div>
									@if(auth('Admin')->check())
									{{-- <a class="dropdown-item" href="{{ route('Profile_admin') }}"><i class="bx bx-user-circle"></i>{{ trans('Dashboard/main-Header_trans.Profile') }}</a> --}}
									<a class="dropdown-item" href="{{ route('Edit_Profile_admin') }}"><i class="bx bx-cog"></i> Edit Profile</a>

									@endif
									<a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>{{ trans('Dashboard/main-Header_trans.Messages') }}</a>
                            ...
                            <form method="POST" action="{{ route('logout.user') }}">
                                @elseif(auth('Admin')->check())
                                    <form method="POST" action="{{ route('logout.admin') }}">
                                        ...
                                        this.closest('form').submit();"><i class="bx bx-log-out"></i>{{ trans('Dashboard/main-Header_trans.sign_out') }}</a>
                                                                    </form>
