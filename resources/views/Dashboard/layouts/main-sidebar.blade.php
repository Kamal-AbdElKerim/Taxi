<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('Dashboard\img\brand\new_logo.png')}}" class="main-logo" alt="logo" ></a>
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							@if(auth('web')->check())
							<h4 class="font-weight-semibold mt-3 mb-0">{{ Str::limit(auth('web')->user()->name, 22, '...') }}</h4>
							<span class="mb-0 text-muted">{{ Str::limit(auth('web')->user()->email, 26, '...') }}</span>

							@else
							<h4 class="font-weight-semibold mt-3 mb-0">{{ Str::limit(auth('Admin')->user()->name, 22, '...') }}</h4>
							<span class="mb-0 text-muted">{{ Str::limit(auth('Admin')->user()->email, 26, '...') }}</span>
							@endif
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('dashboard_profile') }}">Profile</a></li>
